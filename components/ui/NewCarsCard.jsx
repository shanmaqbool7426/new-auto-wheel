...
const NewCarsCard = ({ vehicle, isRating }) => {
  ...
  console.log('>>>>>', vehicle?.averageRating?.$numberDecimal)
  return (
      ...
      >
        ...
        <Flex direction="column" align="center" gap="xs">
          ...
          {isRating && <Flex align="center" justify="center" gap="xs">
            <Rating defaultValue={vehicle?.averageRating?.$numberDecimal ?? 0} />
            <Text span inherit>
              {vehicle?.averageRating?.$numberDecimal
                ? `(${Math.round(parseFloat(vehicle.averageRating.$numberDecimal) * 10) / 10}/5)`
                : null}
            </Text>
