...
export async function generateMetadata({ params, searchParams }) {
  ...
  try {
    ...
    if (slugMake.length === 1) {
      // Make level (e.g., Toyota)
      const make = slugMake[0].replace(/-/g, ' ');
      return {
        title: `${make} Cars for Sale in Australia - aussiemotor`,
        description: `Browse new ${make} cars for sale in Australia. View latest models, prices, specifications and features of ${make} vehicles at aussiemotor.`,
        keywords: `${make} cars, new ${make}, ${make} models, ${make} prices, ${make} specifications`,
        icons: {
      ...
      if (variant) {
        ...
        if (vehicleDetails) {
          ...
          return {
            title: `${make} ${model} ${variant} - New Car Specifications & Pricing - aussiemotor`,
            description: `${make} ${model} ${variant} specifications, features, and pricing. ${vehicleDetails.engineCapacity ? `${vehicleDetails.engineCapacity}cc engine, ` : ''}${vehicleDetails.transmission || ''} transmission. Find this new car at aussiemotor.`,
            keywords: `${make} ${model}, ${variant}, new car, ${make} specifications, ${model} price, ${make} ${model} features`,
            icons: {
              icon: 'https://auto-wheels.s3.eu-north-1.amazonaws.com/uploads/1745263672528_f1804554-b4ad-45a4-baca-8f1a7a31dbaf_removalai_preview.png',
              apple: 'https://auto-wheels.s3.eu-north-1.amazonaws.com/uploads/1745263672528_f1804554-b4ad-45a4-baca-8f1a7a31dbaf_removalai_preview.png',
            },
            openGraph: {
              title: `${make} ${model} ${variant} - New Car Specifications & Pricing - aussiemotor`,
              description: `${make} ${model} ${variant} specifications, features, and pricing. ${price}. Find this new car at aussiemotor.`,
              url: variant ? `https://www.aussiemotor.com/new-cars/${slugMake[0]}/${slugMake[1]}/${slugMake[2] || ''}` : `https://www.aussiemotor.com/new-cars/${slugMake[0]}/${slugMake[1]}/`,
              siteName: "aussiemotor",
              locale: "en_AU",
              type: "website",
      ...
      // Fallback for model level (e.g., Toyota Corolla)
      return {
        title: `${make} ${model}${variant ? ` ${variant}` : ''} - New Car Details - aussiemotor`,
        description: `Explore the new ${make} ${model}${variant ? ` ${variant}` : ''} in Australia. View specifications, features, and pricing for this ${make} vehicle at aussiemotor.`,
        keywords: `${make} ${model}, ${variant ? variant + ', ' : ''}new car, ${make} specifications, ${model} price, ${make} ${model} features`,
        icons: {
          icon: 'https://auto-wheels.s3.eu-north-1.amazonaws.com/uploads/1745263672528_f1804554-b4ad-45a4-baca-8f1a7a31dbaf_removalai_preview.png',
          apple: 'https://auto-wheels.s3.eu-north-1.amazonaws.com/uploads/1745263672528_f1804554-b4ad-45a4-baca-8f1a7a31dbaf_removalai_preview.png',
        },
