...
import FullSpecifications from "@/modules/new-cars/FullSpecifications"
import { fetchVehicleBySlug } from '@/services/new-vehicles'
import { API_ENDPOINTS } from '@/constants/api-endpoints'

const SpecificationVehicleDetailPage = async(params) => {
  const vehicle = await fetchVehicleBySlug(API_ENDPOINTS.NEW_VEHICLE.DETAIL(params.params.slug));
  return (
    <div>
      <FullSpecifications vehicle={vehicle.data}/>
    </div>
  )
}

export default SpecificationVehicleDetailPage
