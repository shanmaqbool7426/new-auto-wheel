    ...
    >
      ...
      <Flex direction="column" gap="5" align="center">
        <Image
          ...
          mx="auto"
          mb="sm"
          alt={`Compare ${vehicle.make}`}
          src={vehicle.defaultImage || "/compare/compare-car.svg"}
        />
        ...
        />
        {vehicle.engine && (
          <Text>{`${vehicle.engine?.displacement || "N/A"} cc | ${
            vehicle.fuelAverage || "N/A"
          } Km/l | ${vehicle.transmission || "N/A"}`}</Text>
        )}
        {vehicle.minPrice && (
          <Text fw={700} size="xl">
            {`Rs ${vehicle.minPrice / 100000} - ${
              vehicle.maxPrice / 100000
            } Lacs`}
          </Text>
        )}
        {vehicle.id && (
